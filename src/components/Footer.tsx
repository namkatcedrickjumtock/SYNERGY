          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                Barbering is an art of creating. Without an eraser, Skilled barbers aren't cheap. Cheap barbers aren't skilled
                </p>
